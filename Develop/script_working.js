...
function pwdLength (min, max){
  if (pwdLength.min >=8){
    if (pwdLength.max <=128)
    return pwdLength;
  }
...
//   }
  ...
  // const getKey = [
  //   function upperCase() {
  //     return keys.lettersUpper[Math.floor(Math.random() * keys.lettersUpper.length)];
  //   },
  //   function lowerCase() {
  //     return keys.lettersLower[Math.floor(Math.random() * keys.lowerCase.length)];
  //   },
  //   function number() {
  ...
  //   const upper = document.querySelector("lettersUpper");
  //   const lower = document.querySelector("lettersLower");
...
// var lettersUpperInput = document.querySelector("lettersUpper").confirm;
// var lettersLowerInput = document.querySelector("lettersLower").confirm;
// var numbersInput = document.querySelector("numbers").confirn;
// var symbolsInput = document.querySelector("symbols").confirm;
// var genPass = document.querySelector("");
